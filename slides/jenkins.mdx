...
🤬 F!@#ing boring 🤬 Copy from or fail 🤬
...
- [new Job](https://jenkins2.gamevy.com/view/all/newJob)
- choose a name and `Pipeline`  as type.
...
- Update jobs with PRs
- Update all the tasks without effort
- No need for configuration access on Jenkins.
- Homogeneous jobs
- Code as jobs/tasks
...
---
# [kahoot](https://play.kahoot.it/v2/lobby?quizId=633ba043-7c36-4766-b2da-003982637e6f)
